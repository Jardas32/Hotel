...
document.addEventListener('click', (e) => {
        ...
        if(e.target.classList.contains('imghotel')) {
             let card = e.target.closest('.newhotel');

             let img = card.querySelector('.imghotel').src;
             let title = card.childNodes[3].childNodes[1].childNodes[1].textContent;
             let price = card.childNodes[3].childNodes[9].childNodes[1].textContent;
